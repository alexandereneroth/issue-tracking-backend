...
insert into tblUser (id, number, firstname, lastname, username, team_id) values (1, 101, 'Kelly', 'Lewis', 'klewis0', 1);
insert into tblUser (id, number, firstname, lastname, username, team_id) values (2, 102, 'William', 'Edwards', 'wedwards1', 1);
insert into tblUser (id, number, firstname, lastname, username, team_id) values (3, 103, 'Sharon', 'Howell', 'showell2', 1);
insert into tblUser (id, number, firstname, lastname, username, team_id) values (4, 104, 'Roy', 'Rogers', 'rrogers3', 1);
insert into tblUser (id, number, firstname, lastname, username, team_id) values (5, 105, 'Julia', 'Gonzales', 'jgonzales4', 1);
